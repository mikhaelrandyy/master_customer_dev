...
class CustomerDevGroupBase(SQLModel):
    customer_parent_id: str | None = Field(nullable=False, foreign_key="customer_dev.id")
    customer_reference_id: str | None = Field(nullable=False, foreign_key="customer_dev.id")
